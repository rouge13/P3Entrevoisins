...
// Créer une nouvelle liste DUMMY_FAVORITES_LIST pour stocker les neighbours qui sont ajouté en favoris
    public static List<Neighbour> DUMMY_FAVORITES_LIST = Arrays.asList();
// Générer la liste qui va nous retourner les DUMMY_FAVORITES_LIST qui provient de DummyNeighbourApiService de la fonction getNeighboursFavorite
    static List<Neighbour> generateFavorites() {
        return new ArrayList<>(DUMMY_FAVORITES_LIST);
    }
}
